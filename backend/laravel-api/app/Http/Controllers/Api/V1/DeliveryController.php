...
class DeliveryController extends Controller
{
    ...
    {
        return $this->success(new DeliveryResource($delivery->load(['customer', 'warehouse', 'salesOrder.salesPerson', 'salesOrder.tax', 'salesOrder.branch', 'items', 'invoices', 'termsOfPayment'])));
    }
