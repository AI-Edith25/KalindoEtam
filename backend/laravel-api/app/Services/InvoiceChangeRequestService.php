...
{
    protected const INVOICE_EAGER = ['customer', 'salesOrder', 'delivery', 'items.tax', 'tax', 'termsOfPayment', 'accountsReceivable.receiptEntryItems.receiptEntry.cashAccount', 'creditNotes', 'debitNotes'];
