...
/**
 * Adds master.warehouses.import — 1-Step Import, Warehouses (Area).
 * Same idempotent pattern as 2026_08_31_000002_add_master_items_import_permission.php.
 */
return new class extends Migration
{
    protected string $permissionName = 'master.warehouses.import';

    protected string $trustedPermission = 'master.warehouses.create';
