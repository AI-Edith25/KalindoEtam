...
/**
 * Adds master.customers.import — 1-Step Import, Customers.
 * Same idempotent pattern as 2026_08_31_000002_add_master_items_import_permission.php.
 */
return new class extends Migration
{
    protected string $permissionName = 'master.customers.import';

    protected string $trustedPermission = 'master.customers.create';
