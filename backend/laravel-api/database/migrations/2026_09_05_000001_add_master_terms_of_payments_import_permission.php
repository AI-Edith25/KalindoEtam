...
/**
 * Adds master.terms_of_payments.import — 1-Step Import, Terms of Payment.
 * Same idempotent pattern as 2026_08_31_000002_add_master_items_import_permission.php.
 */
return new class extends Migration
{
    protected string $permissionName = 'master.terms_of_payments.import';

    protected string $trustedPermission = 'master.terms_of_payment.create';
