...
export function RevenueExpenseChart() {
  ...
  return (
    <Card className="cursor-pointer transition-colors hover:bg-accent/50" onClick={() => navigate('/reports/general-ledger/profit-loss')}>
      <CardHeader>
      ...
      <CardContent>
        {isLoading ? (
          ...
          <ResponsiveContainer width="100%" height={256}>
            <BarChart data={data} onClick={(event) => event && navigate('/reports/general-ledger/profit-loss')}>
