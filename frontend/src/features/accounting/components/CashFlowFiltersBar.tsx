...
interface CashFlowFiltersBarProps {
  value: CashFlowFilterValues
  onChange: (value: CashFlowFilterValues) => void
}
  ...
  return (
    <FilterPanel onClear={() => onChange(emptyCashFlowFilters)} hasActiveFilters={hasActiveCashFlowFilters(value)}>
      <div className="flex flex-col gap-1.5">
        ...
        <Select value={value.periodPreset} onValueChange={(next) => onChange({ ...value, periodPreset: next as CashFlowPeriodPreset })}>
