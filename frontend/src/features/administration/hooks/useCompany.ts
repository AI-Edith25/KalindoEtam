...
import { fetchCompanyBranding, fetchCompanyBrandingLogoObjectUrl, fetchCompanyPrintHeader, fetchCurrentCompany } from '../api/companyApi'
...
/** Invoice/document print pages — address/phone/email/npwp, works for every authenticated user regardless of company.view. */
export function useCompanyPrintHeader() {
  return useQuery({ queryKey: ['company-print-header'], queryFn: fetchCompanyPrintHeader })
}
